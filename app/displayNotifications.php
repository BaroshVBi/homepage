<?php
	...
	if($count > 0) {
		...
		echo "</div></div><div id='notify_tab_controls' class='col-12'><div class='col-1 center cursor_pointer' onclick=''>&#10094;</div>";
		for($i = 1; $i <= $count; $i++ ){
			echo "<div class='col-1 center cursor_pointer notify_tab_dot' onClick='notifyTab(this);'>O</div>";
		}
		echo "<div class='col-1 center cursor_pointer' onclick=''>&#10095;</div></div>";
	} 
	else {
